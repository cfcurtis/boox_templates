...
\newcommand{\specialdates}{
  if (equals=2024-09-05) {\shadedate{green}} % first day of class
  if (equals=2024-12-09) {\shadedate{green}} % last day of class
  if (between=2024-10-14 and 2024-10-18) {\shadedate{blue}} % Reading week
  if (equals=2024-04-01) {\shadedate{blue}} % Easter Monday
